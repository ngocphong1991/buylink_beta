...
Class GooglePR {
	...
	function GetPR($url,$forceNoCache = false) {
		...
		if (($url.""!="")&&($url.""!="http://")) {
			...
			$ch=$checksum->getGoogleChecksum($url);
			$querystring = sprintf("client=navclient-auto&ch=6%u&features=Rank&q=", $ch);
			///////////////////
			...
			//$this->debugRes("content",$contents);
