                                    ...
                                    <div class="tab-pane fade {if !$tabactive or $tabactive eq 2}active in{/if}" id="blmtab2">
                                        <form method="get" id="marketplaceFilter" class="form-horizontal">
                                            <div class="control-group">
                                                <div class="form-group">
                                                    <div class="col-md-5">
                                                        <input type="text" class="col-md-12 border-blue" name="keywords" value="{if $keywords}{$keywords}{else}Nhập từ khóa cần tìm{/if}" onfocus="updateTextFieldLabel(this, true, 'Nhập từ khóa cần tìm');" onblur="updateTextFieldLabel(this, false, 'Nhập từ khóa cần tìm');">

                                                    </div>
                                                    <div class="col-md-4">
                                                        <select class="col-md-12" id="filterCategory" name="adv_id" size="1">
