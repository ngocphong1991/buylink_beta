                        ...
                        <form class="form-horizontal" id="marketplaceFilter" method="get">
                            <div class="control-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="col-md-12" name="domain" onblur="updateTextFieldLabel(this, false, 'Tên miền');" onfocus="updateTextFieldLabel(this, true, 'Tên miền');" value="{if isset($smarty.get.domain) && $smarty.get.domain !=''}{$smarty.get.domain}{else}Tên miền{/if}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <input type="text" onblur="updateTextFieldLabel(this, false, 'Nhập từ khóa cần tìm');" onfocus="updateTextFieldLabel(this, true, 'Nhập từ khóa cần tìm');" value="{if isset($smarty.get.keywords) && $smarty.get.keywords !=''}{$smarty.get.keywords}{else}Nhập từ khóa cần tìm{/if}" name="keywords" class="col-md-12 border-blue">
                                    </div>
                                </div>
                                <div class="form-group">
