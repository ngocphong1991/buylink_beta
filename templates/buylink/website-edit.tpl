                              ...
                              <div class="control-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          ...
                                          <p style="margin-top: 10px" class="small alert col-md-12 alert-warning">Từ Khóa là thứ miêu tả tốt nhất về Website của bạn. Nó sẽ giúp người dùng dễ dàng tìm thấy website của bạn trong khi tìm kiếm các site cho quảng cáo Text Link. Mỗi từ khóa phải được phân cách bằng một dấu phẩy.</p>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          <select size="1" name="cats1" onchange="javascript: sendReqPost(loc+'js/get_scats.php?cid='+this.value,'sc');" id="cats1" class="col-md-5">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          <select size="1" name="cats2" onchange="javascript: sendReqPost(loc+'js/get_scats.php?cid='+this.value,'sc');" id="cats2" class="col-md-5">
                                              <option value=""></option>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          <select id="adposition" name="adposition" class="col-md-5" size="1">
                                              <option value=""></option>
